...
class SmetaInstructorDataWidget extends StatefulWidget {
  ...
  const SmetaInstructorDataWidget(
    this.instructor, {
    Key? key,
  ...
  @override
  _SmetaInstructorDataWidgetState createState() => _SmetaInstructorDataWidgetState();
}

class _SmetaInstructorDataWidgetState extends State<SmetaInstructorDataWidget> {
