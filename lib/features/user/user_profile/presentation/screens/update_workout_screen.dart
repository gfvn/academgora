...
import 'package:academ_gora_release/features/main_screen/main_screen/domain/enteties/visitor.dart';
import 'package:academ_gora_release/features/main_screen/main_screen/domain/enteties/workout.dart';
import 'package:academ_gora_release/features/main_screen/registration_to_workout/registration_parameters_screen.dart';
import 'package:academ_gora_release/features/main_screen/registration_to_workout/widgets/horizontal_divider.dart';
import 'package:academ_gora_release/features/main_screen/registration_to_workout/widgets/reg_parameters/info_text.dart';
import 'package:academ_gora_release/features/user/user_profile/presentation/screens/user_account_screen.dart';
import 'package:academ_gora_release/features/user/user_profile/presentation/widgets/update_screen/human_info_widget.dart';
import 'package:academ_gora_release/features/user/user_profile/presentation/widgets/update_screen/select_level_of_skating_widget.dart';
import 'package:academ_gora_release/features/user/user_profile/presentation/widgets/update_screen/select_people_count_widget.dart';
            ...
            child: Column(
              children: [
                ...
                Container(
                    ...
                    child: SelectLevelOfSkatingWidget(levelOfSkating!, this)),
                horizontalDivider(
                    10, 10, screenHeight * 0.015, screenHeight * 0.015),
                SizedBox(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: levelOfSkating != null && _checkTextControllers()
                    ? _saveChanges
                    : null,
                child: Center(
                  child: Column(
